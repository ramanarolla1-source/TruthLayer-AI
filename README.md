...
/scripts/: Contains the core logic for the Hesitation Trap and NIST P-256 Hardware Attestation.

/.kiro/hooks/: Automated audit hooks that ensure the implementation stays true to the vocal diagnostic requirements.

3. THE TECH STACK
Vocal Analysis: ElevenLabs Conversational AI (Prosody & Sentiment).

Engineering Environment: Kiro AI-First IDE.

Security: AetherBridge Protocol (Local Hardware Signing for diagnostic integrity).

Narrative: "Silicon-to-Chain" Cognitive Resilience.

4. QUICK START
To run the local intent verification simulation:
